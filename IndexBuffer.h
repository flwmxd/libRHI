...
namespace maple
{
	...
	class  IndexBuffer : public GPUBuffer
	{
	  ...
	  public:
		...
		static auto createRaw(const uint16_t* data, uint32_t count, BufferUsage bufferUsage = BufferUsage::Static, bool gpuOnly = false)->IndexBuffer*;
		static auto createRaw(const uint32_t* data, uint32_t count, BufferUsage bufferUsage = BufferUsage::Static, bool gpuOnly = false)->IndexBuffer*;
