...
#undef STR
	...
	public:
		static auto create(const ShaderTypes& shaderTypes, const VariableArraySize& size = {}, const std::unordered_set<std::string>& dynamicUniforms = {})->std::shared_ptr<Shader>;
