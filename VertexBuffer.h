...
namespace maple
{
	...
	class VertexBuffer : public GPUBuffer
	{
	  ...
	  public:
		...
		static auto createRaw(const BufferUsage& usage = BufferUsage::Static)->VertexBuffer*;
		static auto createRaw(const void* data, uint32_t size, bool gpuOnly = false)->VertexBuffer*;
	};
}        // namespace maple
